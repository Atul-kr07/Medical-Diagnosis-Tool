...
with st.sidebar:
    ...
    st.markdown("<h2 style='color: #ff8e53;'>MediPredict</h2>", unsafe_allow_html=True)
...
# Diagnosis Page
if page == "Diagnosis":
    st.markdown("<div class='header fade-in'>MediPredict: Your Health Companion</div>", unsafe_allow_html=True)
...
# About Page
    ...
    st.markdown("<div class='header fade-in'>About MediPredict</div>", unsafe_allow_html=True)
    st.write("""
    MediPredict is an AI-powered medical diagnosis tool featuring:
